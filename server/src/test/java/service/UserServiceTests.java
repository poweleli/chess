...
//  Register User Tests
    ...
    public void registerUserSuccess() throws Exception {
        ...
        ResultInterface res = userService.register(req);
    ...
    public void registerUserFailure() throws Exception {
        ...
        ResultInterface res1 = userService.register(req);
    ...
    public void loginUserSuccess() throws Exception {
        ...
        ResultInterface res1 = userService.login(req1);
    ...
    public void logoutUserSuccess() throws Exception {
        ...
        ResultInterface res2 = userService.logout(req2);
    ...
    public void clearUser() throws Exception {
        ...
        ResultInterface res1 = userService.clear();

        LoginRequest req2 = new LoginRequest("username", "password");
        ResultInterface res2 = userService.login(req2);
